...
class code{
	...
	protected $img;					//画布资源
	protected $font="BAUHS93.TTF";		//字体
	protected $font_size = 25;		//
	
	protected $codeStr;				//要生成的字符
	...
	*/
	...
	protected function createCode(){
		...
		for($i=0;$i<$this->number;$i++){
			...
			$this->codeStr .= $showcode;
			$codeColor = imagecolorallocate($this->img,rand(160,250),rand(160,250),rand(160,250));	//定义矩形颜色
			imagettftext($this->img,$this->font_size,rand(-40,30),$x,40,$codeColor,$this->font,$showcode);
		}
