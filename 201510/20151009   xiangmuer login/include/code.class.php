...
class code{
	...
	protected $randStr ="23456789";
	protected $code;				//随机数
	
	protected $img;					//画布资源
	protected $font="simhei.ttf";		//字体
	protected $font_size = 17;
	...
	/*
		@number int 显示的字符个数
	*/
	public function __construct($number = 1,$width=100,$height=30){
	...
	protected function createCode(){
		...
		for($i=0;$i<$this->number;$i++){
			...
			imagettftext($this->img,$this->font_size,rand(-40,30),$x,23,$codeColor,$this->font,$code);
