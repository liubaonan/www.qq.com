...
source industrythrottled : industry
{
        type                                    = mysql
        sql_host                                = 192.168.9.118
        sql_user                                = BhI1Amhg
        ...
        #sql_query_pre                           = SELECT * FROM ls_member_ent_brandinfo as b WHERE b.memberid = $memberid
...
index mysqlstemmed : industry
{
        source                  = industrythrottled
        path                    = /usr/local/coreseek/var/data/industry
        docinfo                 = extern
        mlock                   = 0
        morphology              = none
